    ...
    function h(){
      ...
      document.getElementById("mode2").style.top="0.35rem";*/
            ...
            hm.style.textShadow="2px 5px 10px white";
            pr.style.textShadow="none";
            prf.style.textShadow="none";
            tt.style.textShadow="none";
            cntName.style.textShadow="none";
            hm.style.borderBottom="5px outset red";
            pr.style.borderBottom="none";
            prf.style.borderBottom="none";
            tt.style.borderBottom="none";
            cntName.style.borderBottom="none";
        ...
        function pe(){
          ...
          /* document.getElementById("profil").style.top="-0.7rem";
           ...
           document.getElementById("mode2").style.top="0.2rem";*/
            ...
            pr.style.borderBottom="5px outset red";
            prf.style.borderBottom="none";
            tt.style.borderBottom="none";
            cntName.style.borderBottom="none";
        }
          ...
          document.getElementById("firstBar").style.display="block";
            ...
            var prf=document.getElementById("prff") ;
             ...
             /* document.getElementById("profil").style.top="-1.5rem";
              ...
              var cntName=document.getElementById("cnt");
                     ...
                     hm.style.borderBottom="none";
                     pr.style.borderBottom="none";
                     prf.style.borderBottom="5px outset red";
                     tt.style.borderBottom="none";
                     cntName.style.borderBottom="none";
           ...
           function t(){
            ...
            document.getElementById("frc").style.top="0.1rem";*/
                          ...
                          var hm=document.getElementById("hmm") ;
                                     var prf=document.getElementById("prff") ;
                                       ...
                                       var cntName=document.getElementById("cnt");
                                              ...
                                              pr.style.borderBottom="none";
                                              prf.style.borderBottom="none";
                                              tt.style.borderBottom="5px outset red";
                                              cntName.style.borderBottom="none";
               ...
               function Contact(){
                document.getElementById("firstBar").style.display="none";
                /*document.getElementById("profil").style.top="-1.5rem";
                document.getElementById("mode1").style.top="-0.35rem";
                document.getElementById("mode2").style.top="-0.35rem";*/
                var home=document.getElementById("home").style.display="none" ;
                          ...
                          cnt.style.display="block " ;
                          var cntName=document.getElementById("cnt");
                          document.getElementsByClassName("container")[0].style.top="1.3rem"
                           cnt.style.position="relative" ;
                          cnt.style.top="-6rem " ;
                         ...
                         pr.style.borderBottom="none";
                          prf.style.borderBottom="none";
                         tt.style.borderBottom="none";
                           cntName.style.borderBottom="5px outset red";
...
function Active(){
  document.getElementById("picMe").src="me_files/me for phne.png";
...
/*
let ad=document.getElementsByClassName("adap")
for (let i=0 ;i<ad.length;i++){
  ad[i].style.color="black";
  } */
/*
for (let i=1 ;i<ad.length-2;i++){
  ad[i].style.borderBottom="2px solid black";
  } 
  ad[ad.length-1].style.borderBottom="2px solid black";
*/
...
function langueFRC(){
   document.getElementsByClassName("c1")[0].innerHTML="LANGUAGES";
   document.getElementsByClassName("c1")[1].innerHTML="TOOLS";
   //document.getElementById("firstname").placeholder="First Name";
   /*
   document.getElementsByClassName("ktabaSk")[0].innerHTML="C/C++ Programming" ;
   document.getElementsByClassName("ktabaSk")[1].innerHTML="Programming Java";
   document.getElementsByClassName("ktabaSk")[2].innerHTML="Programming Python";
   document.getElementsByClassName("ktabaSk")[3].innerHTML="Web Development HTML, CSS, and JS ";
   document.getElementsByClassName("ktabaSk")[4].innerHTML="Databases MySQL, PHP ";
   document.getElementsByClassName("ktabaSk")[5].innerHTML="Programming MATLAB ";
   document.getElementsByClassName("ktabaSk")[6].innerHTML="Programming SHELL ";
   document.getElementsByClassName("ktabaSk")[7].innerHTML="CATIA 3D design ";
  */
 document.getElementsByClassName("adap")[0].innerHTML="Contact me"
 document.getElementsByClassName("adap")[1].placeholder="First Name" 
 document.getElementsByClassName("adap")[5].innerHTML="Type a Text ..." 
 document.getElementsByClassName("adap")[2].placeholder="Last Name"
 document.getElementsByClassName("adap")[7].value="Send" ; 
...
function langueENG(){
  ...
  document.getElementsByClassName("adap")[0].innerHTML="Contacter Moi"
  document.getElementsByClassName("adap")[1].placeholder="Prenom" 
  document.getElementsByClassName("adap")[5].innerHTML="Taper un Text ..." 
  document.getElementsByClassName("adap")[2].placeholder="Nom"
  document.getElementsByClassName("adap")[7].value="Envoyer" ; 
  document.getElementsByClassName("c1")[0].innerHTML="LANGAGES";
  document.getElementsByClassName("c1")[1].innerHTML="OUTILS";
  
  /*
  document.getElementsByClassName("ktabaSk")[0].innerHTML="Programmation C/C++  ";
   document.getElementsByClassName("ktabaSk")[1].innerHTML="Programmation Java";
   document.getElementsByClassName("ktabaSk")[2].innerHTML="Programmation Python";
   document.getElementsByClassName("ktabaSk")[3].innerHTML="Développement WEB HTML,CSS,et JS  ";
   document.getElementsByClassName("ktabaSk")[4].innerHTML="Bases des Données MySQL ,PHP  ";
   document.getElementsByClassName("ktabaSk")[5].innerHTML="Programmation MATLAB ";
   document.getElementsByClassName("ktabaSk")[6].innerHTML="Programmation SHELL ";
   document.getElementsByClassName("ktabaSk")[7].innerHTML="Conception CATIA 3D  ";
*/
